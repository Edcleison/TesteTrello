...
namespace Automacao
{
    class CapabilitiesMethods
    {
        public IWebDriver BrowserConfig()
        {
            ...
            options.AddArgument("--window-size=1920,1200");  // Ajusta o tamanho para metade da tela
        ...
        public void ScreeanShot()
        {
            ...
            string filePath = Path.Combine($@"C:\TesteTrello-main\TesteTrello-main\Print", fileName);
        ...
        public string ObterCodigoVerificacaoGmail()
        {
            using (var client = new ImapClient())
            {
                ...
                client.Authenticate(Global.user, Global.passApp);
